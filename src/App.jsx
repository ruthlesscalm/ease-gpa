      ...
      <main className="mx-auto flex min-h-screen max-w-3xl flex-col items-center gap-8 px-4 py-8 sm:px-6 lg:max-w-6xl lg:px-10">
        ...
        <footer className="mt-auto flex w-full items-center justify-center gap-2 pb-4 pt-8">
          <a
            ...
            className="group flex items-center gap-1.5 rounded-lg px-3 py-2 text-muted-foreground transition-all duration-200 hover:text-foreground"
          >
            <svg
              className="h-[18px] w-[18px] fill-current transition-transform duration-200 group-hover:scale-110"
              viewBox="0 0 24 24"
